...
- Can allow you to quickly produce a lot of queries on a lot of fields with a high level of dimensionality for filtering
- Can produce a high level of consistency between the behavior of various queries
- Bypasses the web application layer so should have less latency for certain things
- Has built-in cache behavior and some degree of preaggregation support
