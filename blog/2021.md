...
(A very imperfect, cliche, and clickbaity title, but it was the first descriptor that came to mind.)

"Idea guys" are found anywhere there are complex, nuanced problems without clear resolutions. Complex problems are like decomposing logs: if left alone for lone enough, idea guys inevitably start popping up like mushrooms, little toadstools that squeak out "why don't we just do X? It'll fix everything!" It could be in the workplace, in casual conversations... anywhere, really. There is no escape.

At a high level, idea guys are rarely _wrong_. Their suggestions really do illustrate a better world, a utopic alternative to whatever dumpster fire is currently under discussion. But in terms of practical usefulness, the value of their ideas rounds down to zero. Complex problems are complex because they are nuanced, and idea guys perceive nuance like how dogs perceive color. Anyone with a pulse can idly theoreticize and come up with their own vision of utopia; idea guys embrace and evangelize their visions, while ignoring the fact that they might have to commit atrocities to enact their utopias, or that their utopias would last for maybe ten minutes before some real world detail causes the whole thing to crash down.

I'm not advocating that people _don't_ share their ideas. But the idea is simply the first step: if an idea does not describe implementation and maintenance, it is simply a dream. If an idea is well fleshed out, it becomes an actionable proposal. Good proposals cover three things: 1) where we want to be, 2) how to get there, and 3) how to _stay_ there. Idea guys only concern themselves with the first item. Take socialism, for instance. Looks great when examining the theoretical outcomes. Oh, there was another case of Cambodian Killing Fields? Curious why that keeps happening, but it's surely not important. The same happens in discussions around healthcare. Or hiring practices. Or immigration. Or wealth inequality. ~Or Zionism.~

Good proposals have enough detail to be thoroughly evaluated, criticized, and possibly implemented. This leads to an unfortunate dilemma where proposals often die by their own merits, and vague ideas are favored instead. Many well thought out proposals die a death by a thousand cuts: due to the level of detail; the surface area available for criticism expands greatly. Oftentimes, a well thought out proposal really is insufficient: hard problems are hard, after all. Ideas, on the other hand, simply sweep the details under the rug. They can be hard to disagree with because they're not saying anything disagreeable; however, on closer inspection, they're not saying much of anything at all.
