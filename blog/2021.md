...
# Mind the confidence-competence gap
...
However, confidence is only part of the picture. Overconfidence doesn’t necessarily lead to negative outcomes if that confidence is backed by a similarly high level of competence. Conversely, lack of confidence in beginners can act as a motivator to pursue higher levels of competence. The “right level” of confidence is relative to one’s competence, and *managing the confidence-competence gap* is an important step in maintaining a healthy and consistent rate of personal growth.
...
![](https://cdn-images-1.medium.com/max/2094/1*WYG64HiIlpLPKiSPQK7zeQ.png)

Unfortunately, it’s unclear how to determine this range: psychologists have been trying to objectively measure confidence and competence for decades, and we all know what the effect sizes and reproducibility metrics look like (they ain’t pretty). Rather than attempting to derive some precise relationship, I find it more useful to think about what the various cases of confidence-competence mismatch look like, and use these examples as calibration for self-evaluation.

In my head, I subdivide this chart of competence vs. confidence into four quadrants: *beginner*, *impostor syndrome*, *optimal*, and what I will simply call *“fucked”*.

![](https://cdn-images-1.medium.com/max/2094/1*vXpac2xKQVpyzUI8QTWdaA.png)

By exploring each in turn, we can identify attributes of confidence-competence mismatch to avoid, as well as attributes of confidence-competence alignment to pursue.
...
“okay I’ve conned these rubes into paying me and I need to work 14 hours a day or they’ll find out I’m a fraud and how does my coworker who’s two years older than me know everything under the sun and what the hell is this [insane flowchart of skills](https://roadmap.sh/frontend) and I can’t tell if our architect is listing off [technologies or Pokémon](https://pixelastic.github.io/pokemonorbigdata/)” phase. After several cycles of “I have no idea what the hell I am doing”, there’s eventually a moment of “wait, I actually do kind of know what I’m doing” where you realize both your confidence and competence have leveled up just a little bit.
...
Impostor syndrome is prevalent at all levels of competence, and is probably the default quadrant for beginners to transition to. Confidence generally trails confidence, meaning that nearly all early career engineers are capable of more than they think they are. High performers may be particularly susceptible to impostor syndrome: they may know that growth is fastest at the edge of one’s comfort zone, but constantly being at the edge may lead to a toxic level of self-doubt.
...
Ideally, this quadrant is the end state for engineers. However, there’s always a risk of transitioning back to the “impostor syndrome” quadrant. As previously mentioned, good engineers aim to live at the edge of their comfort zone, which can erode self-confidence over time. I’ve met several engineers that fluctuate between “impostor syndrome” and “optimal.” It’s certainly better than the alternative: for some engineers, confidence continues to grow unbounded, and they transition to the final quadrant: “fucked.”
...
“Fucked” engineers often consider themselves as having defeated impostor syndrome. When hearing about young programmers struggling with impostor syndrome, they nod sagely and sanctimoniously recount how they too used to be plagued by self-doubt, until they learned to shout it down and block it from their heads. These are the very people who should be paying attention to their inner voice! Self-doubt can be crippling, but it can also be a warning bell that one is going off the deep end of delusional self-confidence. Once this voice has been silenced, future growth is stunted, and it is incredibly difficult to get back on the right path. They’re fucked.

“Fucked” engineers are increasingly likely to attribute blame externally. They’re so skilled that they couldn’t possibly be the source of the problem, after all. When encountering problems with some unfamiliar tool, they are increasingly likely to blame the tool over their own lack of understanding. They make a snap judgment about the quality of the tool, complain about “pointless new paradigms,” and wonder why everyone doesn’t just use the old tool they are familiar with. Their capability to learn thus atrophies over time, and they ultimately become outdated and irrelevant. They constantly rail about how modern tech is all garbage, and how today’s programmers are idiots. (While we generally think of these engineers as “crusty old dinosaurs,” I’ve found that young engineers can be just as “fucked” as older ones — we just latch on to the older ones because they reinforce our existing stereotypes. You don’t have to be old for your confidence to exceed your competence.)

(It’s feasible but unlikely to transition from “beginner” to “fucked.” Those who do are generally quickly brought down to size, and transition back to the “beginner” quadrant.)
...
1. Uber CTO Thuan Pham (2013–2020). Prerequisite of Uber being toxic yada yada, but I really admire this quote:
